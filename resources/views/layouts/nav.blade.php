<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm p-2">
    <div class="container">
        ...
        <a class="navbar-brand text-primary font-weight-bold text-uppercase" href="{{ route('web') }}">
            openshop
        </a>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        @endcan
                        @can('view-any', App\Models\GeneralSetting::class)
                        <a class="dropdown-item" href="{{ route('general-settings.index') }}">General Settings</a>
                        @endcan
