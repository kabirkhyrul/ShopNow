    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.reviews.index_title')</h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th>@lang('crud.reviews.inputs.product_id')</th>
                            <th>@lang('crud.reviews.inputs.user_id')</th>
                            <th>@lang('crud.reviews.inputs.body')</th>
                            <th>@lang('crud.reviews.inputs.ratings')</th>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5">{!! $reviews->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
