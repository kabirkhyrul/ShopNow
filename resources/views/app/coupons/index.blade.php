        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th>@lang('crud.coupons.inputs.code')</th>
                            <th>@lang('crud.coupons.inputs.start_date')</th>
                            <th>@lang('crud.coupons.inputs.expired_date')</th>
                            <th>@lang('crud.coupons.inputs.discount_type')</th>
                            <th>@lang('crud.coupons.inputs.amount')</th>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">{!! $coupons->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
